...
describe('EventsController', () => {
  ...
  describe('findAll', () => {
    it('should return an array of events', async () => {
      ...
      expect(await controller.findAll(mockRequest.headers.authorization)).toBe(
        result,
      );
  ...
  describe('findOne', () => {
    it('should return a single event', async () => {
      ...
      expect(
        await controller.findOne(id, mockRequest.headers.authorization),
      ).toBe(result);
  ...
  describe('remove', () => {
    it('should remove an event', async () => {
      ...
      expect(
        await controller.remove(id, mockRequest.headers.authorization),
      ).toBe(result);
  ...
  describe('getEventReservations', () => {
    it('should get reservations for an event', async () => {
      ...
      expect(
        await controller.getEventReservations(
          id,
          mockRequest.headers.authorization,
        ),
      ).toBe(result);
  ...
  describe('getInstallments', () => {
    it('should get installments for an event', async () => {
      ...
      expect(
        await controller.getInstallments(id, mockRequest.headers.authorization),
      ).toBe(result);
